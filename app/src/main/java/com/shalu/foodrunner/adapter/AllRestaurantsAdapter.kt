package com.shalu.foodrunner.adapter
...
import com.shalu.foodrunner.database.RestaurantEntity
import com.shalu.foodrunner.fragment.RestaurantFragment
import com.shalu.foodrunner.model.Restaurants
...
class AllRestaurantsAdapter(private var restaurants: ArrayList<Restaurants>, val context: Context) :
    ...
    class DBAsyncTask(context: Context, val restaurantEntity: RestaurantEntity, val mode: Int) :
        ...
        val db = databaseBuilder(context, RestaurantDatabase::class.java, "res-db").build()
